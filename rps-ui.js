    ...
    */
    ...
    function game() {
      ...
      */ 
          ...
          for (let i = 0; i < 5; i++) {
              let playerSelection = window.prompt("Make your move: rock, paper, or scissors?");
      ...
      for (let i = 0; (i = 6); i++) {
        if (userScore > computerScore) {
          ...
          console.log("Game over. You lose. Final Score: " + userScore + "," +
            computerScore);
        } else if (userScore == computerScore) {
          console.log("Game over. It was a tie. Final Score: " +
            userScore + "," + computerScore);
        } else { console.log("Something went wrong. It wasn't me."); }
      }
    }
